...
while($fila = mysqli_fetch_array($resultado)) {
	...
	echo "<br>";
	echo "<a href='producto.php?id=".$fila['id']."'><button class='btn btn-primary btn-sm'>Más información</button></a>";
	echo "<button value='".$fila['id']."' class='botoncompra btn btn-success btn-sm'>Comprar ahora</button>";
	echo "</article>";
} 
